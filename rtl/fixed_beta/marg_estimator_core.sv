`timescale 1ns/1ps
// Low-resource MARG attitude estimator for xc7z020clg400-2.
//
...
module marg_estimator_core #(
    ...
    logic        [31:0] dt_l, beta_l, one_minus_beta_l;
    ...
    always_ff @(posedge clk) begin
        if (!rst_n) begin
            ...
            dt_l                <= '0; beta_l <= '0; one_minus_beta_l <= '0;
            ...
            case (state)
                C_IDLE: begin
                    if (in_valid && in_ready) begin
                        ...
                        one_minus_beta_l <= $unsigned(ONE_Q30) -
