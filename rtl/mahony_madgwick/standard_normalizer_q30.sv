`timescale 1ns/1ps
// Conventional vector normalizer: x / sqrt(sum(x_i^2)).
// DIM may be 3 or 4.  The single sequential sqrt/divide datapath is reused
// across components to keep this baseline deterministic and auditable.
