`timescale 1ns/1ps
// Identical 11-word input / five-word output wrapper for the conventional
// baseline filters.  Word 10 is retained as a configuration slot so the
// wrapper overhead matches the SAAM-family experiments; current gains are
// compile-time parameters and the slot is intentionally not used by the core.
