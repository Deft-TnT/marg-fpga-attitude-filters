`timescale 1ns/1ps
// Exact unsigned restoring divider.  It avoids a wide combinational divider
// and is used only by the conventional sqrt/divide normalizer.
module standard_div_u64_u32_seq (
    input  logic        clk,
    input  logic        rst_n,
    input  logic        start,
    ...
    always_ff @(posedge clk) begin
        if (!rst_n) begin
            ...
            if (!busy) begin
                ...
                remainder_shift = {remainder_work[31:0], dividend_shift[63]};
